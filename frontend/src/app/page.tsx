    ...
    <>
      ...
      >
        ...
        <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center pt-20 px-6 overflow-hidden">
           ...
           <div className="hero-glow absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-teal-500/10 blur-[120px] rounded-full pointer-events-none" />
           <div className="absolute top-0 left-0 w-full h-full opacity-20 pointer-events-none" 
             style={{ backgroundImage: 'radial-gradient(circle, #0F969C 1px, transparent 1px)', backgroundSize: '60px 60px' }} />

           <div className="relative z-10 text-center max-w-5xl mx-auto">
              <div className="hero-cta inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-teal-500/10 border border-teal-500/20 mb-8">
                 <Zap className="w-3 h-3 text-teal-400" />
                 <span className="text-[8px] font-black uppercase tracking-[0.4em] text-teal-400">Deep Sea Artisan v2.0</span>
              </div>

              <h1 ref={heroTitleRef} className="text-6xl md:text-[10rem] font-black text-white leading-[0.85] tracking-tighter mb-12 uppercase">
           ...
           <div ref={heroImageRef} className="relative w-full max-w-3xl aspect-[16/9] mt-10 rounded-[40px] overflow-hidden border border-white/10 shadow-2xl">
              <img 
           ...
           <div className="max-w-7xl mx-auto">
              <div className="reveal flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
                 <div>
                    <div className="flex items-center gap-2 mb-4">
                       ...
                       <span className="text-[10px] font-black uppercase tracking-[0.4em] text-teal-400">The Selection</span>
                    </div>
                    <h2 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter">Featured Essence</h2>
                 </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                 {FEATURED.map((item, idx) => (
                   <div 
                    key={idx} 
                    className="reveal group relative p-8 rounded-[40px] bg-white/5 border border-white/10 transition-all hover:bg-white/[0.08] hover:-translate-y-2"
                   >
                      <div className="relative aspect-square rounded-3xl overflow-hidden mb-8 border border-white/5">
                         <img src={item.img} alt={item.name} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                      </div>
                      <div className="flex justify-between items-start mb-4">
                         <div>
                            <h3 className="text-xl font-black text-white uppercase tracking-tight mb-1">{item.name}</h3>
                            <p className="text-[9px] font-black uppercase tracking-widest text-teal-400">{item.tag}</p>
                         </div>
        ...
        <section className="py-32 px-6 overflow-hidden">
           <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div className="reveal relative">
                 <div className="absolute -top-20 -left-20 w-64 h-64 bg-teal-500/20 blur-[100px] rounded-full" />
                 <div className="relative rounded-[60px] overflow-hidden border border-white/10 aspect-square">
                    <img 
                 ...
                 <div className="absolute -bottom-10 -right-10 p-10 rounded-[40px] bg-teal-500 text-[#05161A] shadow-2xl hidden md:block">
                    <Coffee className="w-12 h-12 mb-4" />
                    <p className="text-2xl font-black leading-tight uppercase tracking-tighter italic">Pure<br/>Depth</p>
                 </div>
              </div>
              ...
              <div className="reveal">
                 <div className="flex items-center gap-2 mb-6">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.4em] text-teal-400">The Philosophy</span>
                 </div>
                 <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter mb-10 leading-[0.9]">Beyond The<br/>Surface</h2>
                 ...
                 <div className="grid grid-cols-2 gap-8 mb-12">
                    <div>
                       <h4 className="text-white font-black text-2xl mb-2">100%</h4>
                       <p className="text-[10px] uppercase tracking-widest text-white/40">Artisan Beans</p>
                    </div>
                    <div>
                       <h4 className="text-white font-black text-2xl mb-2">0.4s</h4>
                       <p className="text-[10px] uppercase tracking-widest text-white/40">Sync Speed</p>
                    </div>
                 </div>
        ...
        {/* FOOTER */}
        <footer className="pt-32 pb-12 px-6 md:px-12 border-t border-white/5">
           <div className="max-w-7xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12 mb-20">
                 <div>
                    <div className="flex items-center gap-3 mb-6">
                       ...
                       <span className="font-black tracking-[0.4em] uppercase text-[10px] text-white">Kedai Core</span>
                    </div>
                    <p className="text-white/40 text-xs font-medium tracking-wide">Crafting digital experiences through artisan flavors.</p>
                 </div>

                 <div className="flex gap-6">
                    <a href="#" className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white/40 hover:text-teal-400 transition-colors border border-white/5"><Globe className="w-5 h-5" /></a>
                    <a href="#" className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white/40 hover:text-teal-400 transition-colors border border-white/5"><Mail className="w-5 h-5" /></a>
                    <a href="#" className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white/40 hover:text-teal-400 transition-colors border border-white/5"><Zap className="w-5 h-5" /></a>
                 </div>
              </div>

              <div className="flex flex-col md:flex-row justify-between items-center gap-8 pt-12 border-t border-white/5">
                 <p className="text-[9px] font-black uppercase tracking-[0.2em] text-white/20">© 2026 KEDAI CORE. ALL RIGHTS RESERVED.</p>
                 <div className="flex gap-10">
                    <a href="#" className="text-[9px] font-black uppercase tracking-[0.2em] text-white/20 hover:text-white/40 transition-colors">Privacy Policy</a>
                    <a href="#" className="text-[9px] font-black uppercase tracking-[0.2em] text-white/20 hover:text-white/40 transition-colors">Terms of Sync</a>
                 </div>
              </div>
           </div>
        </footer>
